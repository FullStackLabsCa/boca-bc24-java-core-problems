...
public class ChunkProcessorUtil implements Runnable {

    private final String chunkFileName;
    private final HikariCPDataSource dataSource;
    private final practice.multi_threading.trading_processing_assignment.service.QueueDistributor queueDistributor;

    public ChunkProcessorUtil(String chunkFileName, HikariCPDataSource dataSource, QueueDistributor queueDistributor) {
    ...
    public void run() {
        try {
            ...
            for (String line : chunkLines) {
                ...
                String queueId = queueDistributor.assignQueue(accountNumber);
                queueDistributor.addToQueue(queueId, tradeId);
            }
