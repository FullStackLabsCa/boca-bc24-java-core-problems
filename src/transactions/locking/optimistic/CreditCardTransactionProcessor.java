package transactions.locking.optimistic;
...
public class CreditCardTransactionProcessor {
    ...
    public static void main(String[] args) {
        ...
        readTransactionFileAndWriteToQueue("/Users/Mann.Bhatt/downloads/credit_card_transactions.txt");
...
//        connection.setAutoCommit(true);
    ...
    private void updateAccountBalance(Connection connection, CreditCardTransaction creditCardTransaction, int version) throws SQLException {
        ...
        String selectQuerry = "SELECT balance FROM accounts WHERE credit_card_number = ?";

        PreparedStatement selectstmt = connection.prepareStatement(selectQuerry);
        selectstmt.setString(1, creditCardTransaction.getCreditCardNumber());
        ...
        if (creditCardTransaction.getTransactionType() == "buy") {
            stmt.setDouble(1, currentBalance - creditCardTransaction.getAmount());
