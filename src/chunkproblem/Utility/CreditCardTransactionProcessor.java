...
public class CreditCardTransactionProcessor {
    ...
    private static ArrayBlockingQueue<CreditCardTransaction> creditCardTransactionQueue
    ...
    public static void main(String[] args) {
        ...
        readTransactionFileAndWriteToQueue("/Users/robinbajaj/source/boca-java-core-code-samples/boca-core-java-examples/credit_card_transactions.txt");
...
class TransactionConsumer implements Runnable {
    ...
    public void run() {
        while (true) {
            try {
                CreditCardTransaction creditCardTransaction = retriveCreditCardTransaction(creditCardTransactionQueue);
    ...
    private static synchronized CreditCardTransaction retriveCreditCardTransaction(ArrayBlockingQueue<CreditCardTransaction> creditCardTransactionQueue) throws InterruptedException {
