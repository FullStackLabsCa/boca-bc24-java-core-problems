package io.reacticestax.jdbc.lockingOptimistic;
...
public class CreditCardTransactionProcessor {
    ...
    private static ArrayBlockingQueue<CreditCardTransaction> creditCardTransactionQueue = new ArrayBlockingQueue<>(5000, true);
    ...
    public static void main(String[] args) {
        ...
        readTransactionFileAndWriteToQueue("/Users/akshitabajaj/Documents/reactiveStax/boca-bc24-java-core-problems/src/jdbc/lockingOptimistic/credit_card_transactions.txt");
...
//creditCardTransactionProcessor class ends here......
