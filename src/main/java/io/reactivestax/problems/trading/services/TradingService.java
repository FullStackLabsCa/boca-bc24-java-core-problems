package io.reactivestax.problems.trading.services;

import com.zaxxer.hikari.HikariDataSource;
import io.reactivestax.problems.trading.customexceptions.HitErrorsThresholdException;
import io.reactivestax.problems.trading.databaseconnection.TradingDatabaseConnection;
import io.reactivestax.problems.trading.repository.TradingRepository;
import io.reactivestax.problems.trading.tradingmodel.TradingValues;

import static io.reactivestax.problems.trading.TradingProcessor.dataSource;
...
//                TradingValues tradingValues;
    ...
    public static void logReaderErrors(String errorsInReading) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/Shifa.Kajal/source/student/boca-bc24-java-core-io.reactivestax.problems/src/io.reactivestax.problems/trading/tradesutility/Trade_reading_error_log", true))) {
    ...
    public static void logWritingErrors(String errorsInWriting) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/Shifa.Kajal/source/student/boca-bc24-java-core-io.reactivestax.problems/src/io.reactivestax.problems/trading/tradesutility/Trade_writing_error_log", true))) {
