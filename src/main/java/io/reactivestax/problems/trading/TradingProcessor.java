package io.reactivestax.problems.trading;

import com.zaxxer.hikari.HikariDataSource;
import io.reactivestax.problems.trading.customexceptions.InvalidThresholdRuntimeException;
import io.reactivestax.problems.trading.customexceptions.InvalidThresholdValueException;
import io.reactivestax.problems.trading.repository.TradingRepository;
import io.reactivestax.problems.trading.services.TradingService;
...
import static io.reactivestax.problems.trading.databaseconnection.TradingDatabaseConnection.configureHikariCP;
import static io.reactivestax.problems.trading.services.TradingService.setupDBConnectionAndRunFileReading;
...
public class TradingProcessor {
    ...
    public static double getThresholdFromApplicationProperties() {
        ...
        try {
            properties.load(new FileReader("/Users/Shifa.Kajal/source/student/boca-bc24-java-core-io.reactivestax.problems/src/io.reactivestax.problems/trading/application.properties"));
