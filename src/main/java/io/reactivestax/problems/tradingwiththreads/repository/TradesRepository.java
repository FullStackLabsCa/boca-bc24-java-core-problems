package io.reactivestax.problems.tradingwiththreads.repository;
...
import io.reactivestax.problems.tradingwiththreads.model.RawPayload;
...
public class TradesRepository {
    public void insertInRawTable(RawPayload rawPayload, Connection connection) throws SQLException {
  ...
  public static boolean insertIntoJournalTable(JournalEntry journalEntry, HikariDataSource dataSource){
...
//    FOREIGN KEY (cusip) REFERENCES securities_reference(cusip)
//);
    public static void insertIntoPositionsTable(Positions positionsPOJO, Connection connection) {
...
//                connection.rollback();
    ...
    public static boolean checkForPositions(Connection connection, Positions positions) {
    ...
    public static void updatePositions(Connection connection, Positions positions) throws SQLException {
