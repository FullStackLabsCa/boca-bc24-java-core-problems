...
public class TransactionRepository {
    ...
    public static void insertAccount(Connection connection, CreditCardTransaction creditCardTransaction) throws SQLException {
        ...
        System.out.println("creditCardTransaction.getCreditCardNumber() = " + creditCardTransaction.getCreditCardNumber());
        System.out.println("creditCardTransaction.getBalance() = " + creditCardTransaction.getBalance());
