...
import problems.generics.problem6_school.School;
...
public class SchoolTest {
    ...
    public void testAssignGradeToNonEnrolledStudent() {
        ...
        assertTrue(systemOutRule.getLog().contains("Error: Cannot assign grade. Student '54321' is" +
                " not enrolled in course 'Math101'."));
    }
