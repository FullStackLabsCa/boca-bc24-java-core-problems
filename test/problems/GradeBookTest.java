...
public class GradeBookTest {
    ...
    @Test
    public void testCalculateDoubleCalculateAverage() {
        doubleGradeBook.addGrade(85.0);
        doubleGradeBook.addGrade(90.0);
    ...
    @Test
    public void testCalculateDoubleCalculateAverageWithNoGrades() {
    ...
    @Test
    public void testCalculateIntegerCalculateAverage() {
        integerGradeBook.addGrade(85);
        integerGradeBook.addGrade(90);
    ...
    @Test
    public void testCalculateIntegerCalculateAverageWithNoGrades() {
