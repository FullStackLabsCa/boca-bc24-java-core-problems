...
//        stringproblems.Calculator.calculate("3 + 5 M+");
//        assertEquals(8.0, stringproblems.Calculator.recallMemory(), 0.001);
//
//        stringproblems.Calculator.storeInMemory(15.5);
//        assertEquals(15.5, stringproblems.Calculator.recallMemory(), 0.001);
//
//        stringproblems.Calculator.clearMemory();
//        assertEquals("No values stored in memory.", stringproblems.Calculator.recallAllMemory());
//    }
//
//  //  @Test
//    public void testRecallAllMemory() {
//        stringproblems.Calculator.storeInMemory(8.0);
//        stringproblems.Calculator.storeInMemory(15.5);
//        stringproblems.Calculator.storeInMemory(42.0);
//        stringproblems.Calculator.storeInMemory(3.14);
//        stringproblems.Calculator.storeInMemory(99.99);
//        stringproblems.Calculator.storeInMemory(27.5);
//
//        String expected = "Stored values: 27.5, 15.5, 42.0, 3.14, 99.99";
//        assertEquals(expected, stringproblems.Calculator.recallAllMemory());
//    }
}