...
import collection_Implementation_using_array.MyArrayListTest;
...
public class MyArrayListTest {
    ...
    public void testAddElements() {
        ...
        Assert.assertEquals("Size should be 2 after adding two elements", 2, list.size());
        Assert.assertEquals("First element should be 'Apple'", "Apple", list.get(0));
        Assert.assertEquals("Second element should be 'Banana'", "Banana", list.get(1));
    }
    ...
    public void testAddBeyondInitialCapacity() {
        ...
        Assert.assertEquals("Size should be 12 after adding 12 elements", 12, list.size());
        Assert.assertEquals("Last element should be 'Element12'", "Element12", list.get(11));
    }
    ...
    public void testGetElements() {
        ...
        Assert.assertEquals("Element at index 0 should be 'Apple'", "Apple", list.get(0));
        Assert.assertEquals("Element at index 1 should be 'Banana'", "Banana", list.get(1));
    }
    ...
    public void testRemoveElements() {
        ...
        Assert.assertEquals("Size should be 2 after removal", 2, list.size());
        Assert.assertEquals("Element at index 1 should now be 'Cherry'", "Cherry", list.get(1));
    }
    ...
    public void testRemoveFirstElement() {
        ...
        Assert.assertEquals("Size should be 1 after removal", 1, list.size());
        Assert.assertEquals("Element at index 0 should now be 'Banana'", "Banana", list.get(0));
    }
    ...
    public void testListSize() {
        Assert.assertEquals("Size should be 0 for a new empty list", 0, list.size());
        ...
        list.remove(0);
        Assert.assertEquals("Size should be 1 after removing one element", 1, list.size());
    }
    ...
    public void testClearList() {
        ...
        list.clear();
        Assert.assertEquals("Size should be 0 after clearing the list", 0, list.size());
    ...
    public void testAddNullValue() {
        ...
        Assert.assertEquals("Size should be 1 after adding a null value", 1, list.size());
    }
}
